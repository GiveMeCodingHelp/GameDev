...
public class MyGame extends ApplicationAdapter {
    ...
    public void create() {
        ...
        for (int i = 0; i < 5; i++){
            Enemy enemy = new Enemy(400, 100 + i * 60, 50, 50, "assets/fish_blue.png");
    ...
    public void render() {
        ...
        for (int i = 0; i < activeObjects.size(); i++){
            if (activeObjects.get(i).getClass().getSimpleName().equals("Enemy") && activeObjects.getFirst().getHitbox().overlaps(activeObjects.get(i).getHitbox())){
